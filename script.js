...
class Cycling extends Workout {
  type = 'cycling';
  constructor(coords, distance, duration, elvG) {
    super(coords, distance, duration);
    this.elvG = elvG;
    this.calcSpeed();
    this._setDescription();
...
class App {
  ...
  _deleteWorkout(workoutID) {
    let index = this.#workouts.indexOf(workoutID);
  ...
  _renderWorkout(workout) {
    ...
    <li class="workout workout--${workout.type}" data-id="${workout.id}">
          ...
          <div class="workout__details">
            ...
            <button class="work__btn">X</button>
    ...
    <div class="workout__details">
      <span class="workout__icon">⛰</span>
      <span class="workout__value">${workout.elvG}</span>
  ...
  // }
  /////////// create a function under the constructors that can manipulate workouts
  _moveToPopup(e) {
    if (!this.#map) return;
